    ...
    private void showDialog() {
        ...
        btnDone.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                DialogConfirmTask dialogConfirmTask = new DialogConfirmTask(context, task);
                dialogConfirmTask.setMessage(Html.fromHtml(context.getResources().getString(R.string.content_dialog_task_change_status)
                        + "<font color=\"#ff0000\">"
