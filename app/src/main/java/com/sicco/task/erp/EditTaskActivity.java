...
public class EditTaskActivity extends ChooseFileActivity implements
    ...
    private AssignTaskActivity context;
...
//		spnPriority.setOnClickListener(l)
        ...
        txtDateHandle.setText(taskIntent.getNgay_bat_dau());
        txtDateFinish.setText(taskIntent.getNgay_ket_thuc());
...
//                break;
            ...
            case R.id.btnAssign:
                ...
                if (validatFromAssignTask()) {
                    ...
                    try {
                        task.assignTask(
                                getResources().getString(R.string.api_edit_task),
                                Long.parseLong(Utils.getString(
                                        activityContext, "user_id")),
